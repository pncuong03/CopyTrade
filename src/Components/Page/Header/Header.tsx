    ...
    <body className="">
      <nav className="relative px-4 py-5 flex justify-between items-center bg-white">
        <div className="flex">
          ...
          <div className="hidden absolute transform  translate-x-1/2  lg:mx-auto gap-5 lg:flex  lg:items-center  lg:w-auto lg:space-x-6">
            <a className="poppins text-lg font-bold text-[#141411]" href="#">
              Features
            </a>
        ...
        <div className="lg:hidden">
          <button
            className="navbar-burger flex items-center bg-[#456BF1] text-white p-3"
            onClick={toggleMenu}
          >
            <svg
        ...
        <nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
          ...
          <div>
            <ul>
              <li className="mb-1">
                <a
                  className="block p-4 text-sm font-semibold text-[#141411]  hover:bg-blue-50 hover:text-blue-600 rounded"
                  href="#"
                >
                  Features
                </a>
